...
const TransferSTX = ({ address }: Props) => {
  const [recipient, setRecipient] = useLocalStorage<string>("stx_transferSTx-recipient", "")
  const [amount, setAmount] = useLocalStorage<string>("stx_transferSTx-amount", "")
  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        <br />
        <input type="number" value={amount.toString()} onChange={(e) => setAmount(e.target.value)} />
      </p>
      <p>
        <b>Memo</b>
        <br />

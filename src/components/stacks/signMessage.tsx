...
const StacksSignMessage = ({ network }: Props) => {
  const [message, setMessage] = useLocalStorage<string>(`${network}-stx_signMessage`, "Hello world 123")
  ...
  return (
    <div style={{ background: "lightgray", padding: 30, margin: 10 }}>
      ...
      >
        ...
        <button style={{ height: 30, width: 200 }} onClick={onMessagingSigningClicked}>
          Sign message
        </button>
      </div>
    </div>
